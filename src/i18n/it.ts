...
export const it: Dict = {
  ...
  legal: {
    title: "Note legali",
    paragraphs: [
      "Questo sito è una pubblicazione indipendente, edita dal team di RaceWeekStays. Contatto: hello@lemansstays.com. I dati completi dell'editore sono disponibili su richiesta.",
