...
export const EXPLORE_SERIES: Record<Locale, Record<Series, string>> = {
  en: { f1: "More Formula 1 race weekends", motogp: "More MotoGP rounds", endurance: "More endurance classics" },
  fr: { f1: "Plus de week-ends de Formule 1", motogp: "Plus de manches MotoGP", endurance: "Plus de classiques d'endurance" },
  nl: { f1: "Meer Formule 1-weekenden", motogp: "Meer MotoGP-races", endurance: "Meer endurance-klassiekers" },
  de: { f1: "Mehr Formel-1-Rennwochenenden", motogp: "Mehr MotoGP-Rennen", endurance: "Mehr Langstrecken-Klassiker" },
  it: { f1: "Altri weekend di Formula 1", motogp: "Altre gare MotoGP", endurance: "Altri classici endurance" },
  es: { f1: "Más fines de semana de Fórmula 1", motogp: "Más citas de MotoGP", endurance: "Más clásicos de resistencia" },
};
