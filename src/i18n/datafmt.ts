...
const COUNTRIES: Record<string, L> = {
  ...
  "Czech Republic": { en: "Czech Republic", fr: "République tchèque", nl: "Tsjechië", de: "Tschechien", it: "Repubblica Ceca", es: "República Checa" },
  Turkey: { en: "Turkey", fr: "Turquie", nl: "Turkije", de: "Türkei", it: "Turchia", es: "Turquía" },
  ...
  Macau: { en: "Macau", fr: "Macao", nl: "Macau", de: "Macau", it: "Macao", es: "Macao" },
};
...
const EVENTS: Record<string, L> = {
  ...
  "Czech MotoGP": { en: "Czech MotoGP", fr: "MotoGP de Tchéquie", nl: "Tsjechische MotoGP", de: "MotoGP von Tschechien", it: "MotoGP di Cechia", es: "MotoGP de Chequia" },
  ...
  "Turkish Grand Prix": { en: "Turkish Grand Prix", fr: "Grand Prix de Turquie", nl: "Grand Prix van Turkije", de: "Großer Preis der Türkei", it: "Gran Premio di Turchia", es: "Gran Premio de Turquía" },
  ...
  "Macau Grand Prix": { en: "Macau Grand Prix", fr: "Grand Prix de Macao", nl: "Grand Prix van Macau", de: "Grand Prix von Macau", it: "Gran Premio di Macao", es: "Gran Premio de Macao" },
};
