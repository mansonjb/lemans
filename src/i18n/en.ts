...
export const en = {
  ...
  legal: {
    title: "Legal notice",
    paragraphs: [
      "This website is an independent publication, published by the RaceWeekStays team. Contact: hello@raceweekstays.com. Full publisher company details are available on request.",
