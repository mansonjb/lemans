...
export const es: Dict = {
  ...
  legal: {
    title: "Aviso legal",
    paragraphs: [
      "Esta web es una publicación independiente, editada por el equipo de RaceWeekStays. Contacto: hello@lemansstays.com. Los datos completos del editor están disponibles a petición.",
